        ...
        <div class="mkd-full-width">
            <div class="mkd-full-width-inner">
                <div data-mkd-parallax-speed="1"
                    class="vc_row wpb_row vc_row-fluid mkd-section vc_custom_1447839811894 mkd-content-aligment-left mkd-grid-section"
                    style="">
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="mkd-separator-holder clearfix  mkd-separator-center mkd-separator-full-width"
                                            style="margin-top: -9px; margin-bottom: 0px; height: 0px">
                                        ...
                                        <div class="wpb_single_image wpb_content_element vc_align_left">
                                            ...
                                            <figure class="wpb_wrapper vc_figure">
                                                <div class="vc_single_image-wrapper   vc_box_border_grey">
                                                    <img width="600" height="348"
                                                        src="wp-content\uploads\2015\11\cwgm-img.jpg"
                                                        class="vc_single_image-img attachment-full" alt="a"
                                                        srcset="wp-content\uploads\2015\11\cwgm-img.jpg 600w, wp-content\uploads\2015\11\cwgm-img-300x174.jpg 300w"
                            ...
                            <div
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>Never let the future disturb you. You will meet it, if
                                                    you have to, with the same weapons of reason which today
                                                    arm you against. Never let the future disturb you. You
                                                    will meet it, if you have to, with the same weapons of
                                                    reason.</p>
                                        ...
                                        <div class="vc_empty_space" style="height: 50px"><span
                                                class="vc_empty_space_inner"></span></div>
                                        <div
                                            class="mkd-elements-holder mkd-two-columns mkd-responsive-mode-1280">
                                            <div
                                                class="mkd-elements-holder-item mkd-horizontal-alignment-left">
                                                <div class="mkd-elements-holder-item-inner">
                                                    <div class="mkd-elements-holder-item-content mkd-elements-holder-custom-340022"
                                            ...
                                            <div
                                                class="mkd-elements-holder-item mkd-horizontal-alignment-left">
                                                <div class="mkd-elements-holder-item-inner">
                                                    <div class="mkd-elements-holder-item-content mkd-elements-holder-custom-911442"
                                                        style="padding: 0 5px 0 0">
                                                        <div class="mkd-icon-list-item">
                                                            <div class="mkd-icon-list-icon-holder">
                                                                <div class="mkd-icon-list-icon-holder-inner clearfix"
